    ...
    <div className="relative min-h-screen bg-primary">
      ...
      <Navigation>
        <div className="flex flex-col items-center justify-between md:grid md:grid-cols-1 xl:grid xl:grid-cols-2 xl:gap-x-[157px] xl:gap-y-16 xl:max-w-[1110.5px] xl:mx-auto">
          <div className="flex mt-6 md:w-full md:pl-10 md:mt-9 xl:col-span-2 xl:-ml-10 xl:mt-20">
          ...
          <div className="mt-7 xl:max-w-[445px] md:row-start-2 md:grid md:grid-cols-1 md:mx-auto xl:row-start-2 xl:row-span-2">
              ...
              <ul className="flex items-center justify-between space-x-4 md:space-x-4 font-barlow-condensed text-sm tracking-[2.36px] leading-[17px] text-white md:tracking-[2.7px] md:leading-[19.2px] md:text-base md:mt-10 xl:mt-30">
                {technology.map((tech, index) => (
                  <li key={index}>
                    ...
                    >
                      <div
                        className={`flex items-center justify-center mx-auto w-10 h-10 rounded-full xl:w-4 xl:h-4 xl:mt-30 ${
            ...
            <div className="mt-5 md:mt-8 md:max-w-xl xl:mt-16">
              <div className="text-center xl:text-left">
                <h2 className="text-sm uppercase font-barlow-condensed text-secondary leading-[16.8px] tracking-[2.36px]">
                  The Terminology...
                </h2>
                <p className="uppercase font-bellefair text-2xl mt-2 leading-[27.5px] text-white md:text-2xl md:leading-7 xl:text-4xl xl:leading-9">
                  {selectedTechnology.title}
                </p>
                <p className="font-barlow text-[15px] leading-6 mt-2 text-secondary md:text-[40px] md:leading-[46px] md:mt-2 xl:mt-4 xl:text-[56px] xl:leading-[64px] xl:whitespace-nowrap">
